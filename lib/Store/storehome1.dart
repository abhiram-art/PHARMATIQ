...
class StoreHome1 extends StatefulWidget
{
  @override
  _StoreHome1State createState() => _StoreHome1State();
}

class _StoreHome1State extends State<StoreHome1>
{
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("Items1").limit(15).orderBy("publishedDare", descending: true).snapshots(),
