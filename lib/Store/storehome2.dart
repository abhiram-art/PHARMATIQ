...
class StoreHome2 extends StatefulWidget
{
  @override
  _StoreHome2State createState() => _StoreHome2State();
}

class _StoreHome2State extends State<StoreHome2>
{
  @override
        ...
        body: CustomScrollView(
          slivers: [
            ...
            StreamBuilder<QuerySnapshot>(
              stream: Firestore.instance.collection("Items2").limit(15).orderBy("publishedDare", descending: true).snapshots(),
