...
class _UploadPage1State extends State<UploadPage1> with AutomaticKeepAliveClientMixin<UploadPage1>
{
  ...
  {
    final StorageReference storageReference = FirebaseStorage.instance.ref().child("Items1");
  ...
  {
    final itemsRef = Firestore.instance.collection("Items1");
